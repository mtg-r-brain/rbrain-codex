...
- [x] 6.4 Archive this change via `openspec archive scaffold-sibling-repos` once tasks 1.x–5.x are complete and CI is green. (Task 6.3 is outside the spec's scope but tracked for visibility.)
