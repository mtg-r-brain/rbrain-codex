...
- [x] 2.1 Push the 4 planning commits; verify codex CI workflow goes green (9 validators including validate-api-closure picks up the new capability automatically).
- [x] 2.2 Run `/opsx:archive gateway-api` to promote the ADDED delta.
